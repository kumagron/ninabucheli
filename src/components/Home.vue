    ...
    <span>
        ...
        <div class="section quotation" style="text-align:center">
            <div class="w-container">
                <p class="paragraph" style="font-style:normal">
                    ...
                    <br>
                    <small style="font-size:70%">- Aristoteles</small>
                </p>
            </div>
            <div class="w-container" style="padding-top:5px">
                <p class="callout">
                    Also raus aus der Schwere,<br> raus aus dem Leiden und rein in die Fülle, ins Glück.<br>
                    Wo leidest du noch?
                </p>
            </div>
        </div>
        ...
        <div class="section exhibit">
            <div class="w-container">
                <p class="callout" style="color:#efefef">
                    ...
                    Dies zu erforschen, und dich dabei zu begleiten wieder voll in deine Kraft zu kommen,
                    dafür brennt mein Herz als Lebenscoach.
                </p>
            </div>
        </div>
        <!-- <div class="section">
            <div class="w-container">
                <p class="paragraph">
                    Was hindert dich noch daran, ein gesundes, erfüllendes Leben zu führen?<br>
                    Dies zu erforschen, und dich dabei zu begleiten wieder voll in deine Kraft zu kommen,<br>
                    dafür brennt mein Herz als Lebenscoach.
                </p>
            </div>
        </div> -->
        ...
        <div class="section">
            <div class="w-container">
                ...
                <p>
                    <strong><a href="#/contact">Kontaktiere mich</a></strong>
                </p>
            </div>
        </div>
        ...
        <div class="main-section">
            <div class="flex-container w-container">
                ...
                <div style="width:100%">
                    <p class="paragraph header">Hallo, ich bin Nina.</p>
                    <p class="paragraph">Es erfüllt mich mit grosser Demut und gleichzeitig spüre ich aus tiefstem Herzen eine riesige Freude, Menschen dabei zu begleiten, wieder leichter, gesunder und frei durchs Leben zu gehen. Denn ich glaube, dass wir hier sind, um das Leben voll und ganz zu geniessen und nicht, um zu leiden.</p>
                    
                    <p class="paragraph">Ich freue mich sehr darauf dich kennenzulernen.</p>
